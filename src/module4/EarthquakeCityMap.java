...
public class EarthquakeCityMap extends PApplet {
	...
	int earthQuakeCounterLand = 0;
	int earthQuakeCounterOcean = 0;
	...
	public void setup() {
		...
		//System.out.print(cities.get(0).getProperties());
	} // End setup
	...
	private void addKey() {
		...
		fill(255, 255, 255);
		ellipse(55, 330, 10, 10);
		fill(0);
		line(55-10, 330-10, 55+10, 330+10);
		line(55-10, 330+10, 55+10, 330-10);
		textAlign(LEFT, CENTER);
		textSize(12);
...
/*		fill(255, 250, 240);
	...
	private boolean isLand(PointFeature earthquake) {
		...
		// any of them
		// isInCountry(earthquake, "ZAR");
		for (Marker country : countryMarkers) {
			if (isInCountry(earthquake, country)) {
				return true;
				//System.out.print((String)country.getProperty("name")+"\n");
			}
		}

		// System.out.print(earthquake.getProperties());
		// System.out.print("\n");
	...
	private void printQuakes(List<PointFeature> earthquakes, List<Marker> countries) {
		/*
		 * for (Marker country : countries) {
		 * System.out.print(country.getProperties()); }
		 */

		for (Marker country : countries) {
			for (PointFeature earthquake : earthquakes) {
				if (isInCountry(earthquake, country)) {
					earthQuakeCounterLand++;
				}
				
			}
			if (earthQuakeCounterLand > 0) {
				System.out.print((String)country.getProperty("name")+" "+earthQuakeCounterLand+" \n");
				earthQuakeCounterLand = 0;
			}
		}
		
		for (PointFeature earthquake : earthquakes){
			if(!isLand(earthquake)){
				earthQuakeCounterOcean++;
			}
		}
		
		System.out.print("Ocean "+earthQuakeCounterOcean);
