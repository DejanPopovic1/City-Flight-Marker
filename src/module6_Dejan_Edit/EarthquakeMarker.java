...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker marker) {
/*		Float getThisMagnitudeFloat = new Float(this.getMagnitude());
		Float getOtherMagnitudeFloat = new Float(marker.getMagnitude());
		return (-getThisMagnitudeFloat.compareTo(getOtherMagnitudeFloat));*/
